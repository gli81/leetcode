    ...
    def search3(self, nums: list[int], target: int) -> int:
        ...
        while left <= right:
            ...
            if nums[left] <= nums[mid]:
                ## the left sublist is sorted, the right one not
...
def main():
    print(SearchinRotatedSortedArray().search3([4,5,6,7,0,1,2], 0))
    print(SearchinRotatedSortedArray().search3([4,5,6,7,0,1,2], 3))
    print(SearchinRotatedSortedArray().search3([1], 0))

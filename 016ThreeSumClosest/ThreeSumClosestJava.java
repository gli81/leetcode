...
public class ThreeSumClosestJava {
    public static void main(String[] args) {
        System.out.println(new ThreeSumClosestJava().threeSumClosest2(new int[]{-1,2,1,-4}, 1));
        System.out.println(new ThreeSumClosestJava().threeSumClosest2(new int[]{0, 0, 0}, 1));
    }
